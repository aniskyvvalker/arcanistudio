        ...
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <div className="mx-auto flex h-full max-w-[1350px] items-center gap-0 px-5">
            ...
            <div className="flex flex-1 flex-col justify-center gap-12 md:gap-14 lg:flex-row lg:items-center lg:gap-12">
              ...
              {/* Step illustration — wide variant on tablet (550–1023) */}
              <div className="hidden w-full max-w-[750px] shrink-0 min-[550px]:block lg:hidden" style={{ height: 'clamp(230px, 30vw, 300px)' }}>
                <AnimatePresence mode="wait">
                  <motion.div
                    key={activeStep}
                    initial={{ opacity: 0, scale: 0.97 }}
