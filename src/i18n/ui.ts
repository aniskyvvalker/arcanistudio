...
export const ui = {
  en: {
    ...
    portfolio: {
      ...
      projects: [
        { id: 'violette-mode', name: 'Violette Mode', category: 'Fashion boutique', description: 'Full brand identity and e-commerce build for an independent fashion boutique — considered, editorial, built to last.', image: '/images/portfolio/violette-mode.webp' },
        { id: 'pop-pop', name: 'POP POP Café', category: 'Café & boutique', description: 'Bilingual brand site for a rotating café-boutique concept. Playful, local, and never the same twice.', image: '/images/portfolio/pop-pop.webp' },
        { id: 'cafe-buade', name: 'Café Buade', category: 'Fine dining', description: "Heritage restaurant in a historic old quarter — tradition meets modern web. Reservation-first, image-led.", image: '/images/portfolio/cafe-buade.webp' },
        { id: 'maeve-june', name: 'Maeve in June', category: 'Hair salon', description: 'Rebrand and booking site for a fashion-forward hair salon. Black, white, and unapologetically bold.', image: '/images/portfolio/maeve-june.webp' },
        { id: 'upcycli', name: 'Upcycli', category: 'Sustainable fashion', description: 'Independent designers marketplace — 30+ independent brands, curated, conscious, and easy to shop.', image: '/images/portfolio/upcycli.webp' },
  ...
  fr: {
    ...
    portfolio: {
      ...
      projects: [
        { id: 'violette-mode', name: 'Violette Mode', category: 'Boutique de mode', description: "Identité de marque complète et boutique en ligne pour une boutique de mode indépendante — réfléchie, éditoriale, faite pour durer.", image: '/images/portfolio/violette-mode.webp' },
        { id: 'pop-pop', name: 'POP POP Café', category: 'Café & boutique', description: "Site de marque bilingue pour un concept de café-boutique tournant. Ludique, local, et jamais deux fois pareil.", image: '/images/portfolio/pop-pop.webp' },
        { id: 'cafe-buade', name: 'Café Buade', category: 'Gastronomie', description: "Restaurant patrimonial dans un quartier historique — la tradition rencontre le web moderne. Axé réservation, porté par l'image.", image: '/images/portfolio/cafe-buade.webp' },
        { id: 'maeve-june', name: 'Maeve in June', category: 'Salon de coiffure', description: "Refonte de marque et site de réservation pour un salon de coiffure avant-gardiste. Noir, blanc, et audacieux sans complexe.", image: '/images/portfolio/maeve-june.webp' },
        { id: 'upcycli', name: 'Upcycli', category: 'Mode durable', description: "Place de marché de créateurs indépendants — plus de 30 marques indépendantes, sélectionnées, responsables et faciles à magasiner.", image: '/images/portfolio/upcycli.webp' },
