...
export const ui = {
  en: {
    ...
    testimonials: {
      ...
      items: [
        ...
        { quote: "We changed direction halfway through and I braced for the usual fight about scope. They just reworked the plan and moved on. No drama, no surprise invoice.", author: 'Camille T.' },
    ...
    contact: {
      ...
      choiceSteps: [
        ...
        { question: 'When do you need it?', options: ['As soon as possible', '1 – 3 months', '3 – 6 months', 'Just exploring options'] },
  ...
  fr: {
    ...
    testimonials: {
      ...
      headingLine1: 'Directement des gens',
      headingLine2: 'pour qui on a bâti.',
      items: [
        ...
        { quote: "On a changé de direction en cours de route et je m'attendais à la bagarre habituelle sur le périmètre. Ils ont juste retravaillé le plan et avancé. Aucun drame, aucune facture surprise.", author: 'Camille T.' },
        ...
        { quote: "Ce que j'ai apprécié c'est qu'ils répondaient vite, même aux questions un peu bêtes. On ne s'est jamais sentis laissés de côté.", author: 'Rayan B.' },
        { quote: "On est arrivés avec une idée bien arrêtée de ce qu'on voulait. Ils ont posé plein de questions agaçantes et on a fini par construire autre chose. Tant mieux qu'ils l'aient fait.", author: 'Lena W.' },
        ...
        { quote: "On n'était pas un client à gros budget et je m'attendais sans cesse à le ressentir. Jamais.", author: 'Amine D.' },
        { quote: "J'ai lancé plusieurs produits avec différentes agences. C'est le seul studio avec qui la passation s'est vraiment sentie complète.", author: 'Nora J.' },
        { quote: "Ils ont compris notre marché rapidement. On n'a pas eu à réexpliquer sans arrêt ce que font nos clients, ça nous a épargné un paquet de réunions.", author: 'Sofiane M.' },
        ...
        { quote: "Un investisseur a souligné à quel point le produit était réussi avant même qu'on l'ait présenté. Une première.", author: 'Emma C.' },
        { quote: "On avait une idée encore floue et ils en ont fait quelque chose de concret sans la dénaturer. C'est plus rare qu'on ne le croit.", author: 'Lydia O.' },
      ],
    },
    faq: {
